...
def main():
    ...
    ecsDataPath = 'testdata7.txt'
    inputFilePath = 'input.txt'
    resultFilePath = 'result.txt'
    testdata = 'testdata8.txt'

    ecs_infor_array = read_lines(ecsDataPath)
    input_file_array = read_lines(inputFilePath)
    # test_file_array = read_lines(testdata)
    # implementation the function predictVm
    predic_result = predictor2.predict_vm(ecs_infor_array, input_file_array)
